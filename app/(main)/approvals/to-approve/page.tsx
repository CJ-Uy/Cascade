...
export default function ToApproveRequisitionsPage() {
  const [toApproveRequisitions, setToApproveRequisitions] = useState<
    Requisition[]
  >(dummyToApproveRequisitions);
      ...
      render: (requisition: Requisition) => (
        <div className="flex justify-end gap-2">
          ...
          <Button
            variant="secondary"
            size="sm"
            onClick={() => handleAction(requisition, "flag")}
          >
