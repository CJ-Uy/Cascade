              ...
              <TabsContent value="details" className="mt-0 space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Search and select roles to build your approval chain. Drag
                      to reorder, or use the arrows to define the sequence.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="text-xs text-blue-900 dark:text-blue-100">
                            ...
                            <p className="text-blue-800 dark:text-blue-200">
                              ...
                              the next workflow will be automatically triggered.
                            </p>
                          </div>
                        </div>
                      </div>
