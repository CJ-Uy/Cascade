...
-- Issue: field_options table doesn't have order_index column
...
COMMENT ON FUNCTION get_initiatable_templates IS 'Returns all active templates in a business unit that the current user can initiate, along with their workflow information. Fixed: removed order_index from field_options query.';
