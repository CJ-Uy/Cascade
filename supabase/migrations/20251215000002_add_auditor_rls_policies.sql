...
-- Note: We'll create a new policy that includes auditors, then drop the old one
-- This is safer than trying to alter the existing policy

-- Drop the existing policy if it exists (we'll recreate it with auditor support)
