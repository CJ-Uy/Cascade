        ...
        >
          <Link href="/organization-admin/business-units">
            <CardHeader>
              ...
              <CardDescription>
                Manage business units, view details, templates, and workflows
                for each unit
              </CardDescription>
            </CardHeader>
          </Link>
        ...
        >
          <Link href="/organization-admin/system-templates">
            <CardHeader>
              ...
              <CardDescription>
                Create and manage organization-wide form templates that can be
                used across all BUs
              </CardDescription>
            </CardHeader>
          </Link>
        ...
        >
          <Link href="/organization-admin/system-workflows">
            <CardHeader>
              ...
              <CardDescription>
                Configure approval workflows that can be mandated or suggested
                for business units
              </CardDescription>
            </CardHeader>
          </Link>
