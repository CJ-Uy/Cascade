...
const RequisitionDetails: React.FC<RequisitionDetailsProps> = ({
  ...
  const hasBrandOrSupplier = values.items.some(
    (item) => item.brand || item.supplier,
  );
            ...
            <Card>
              <CardContent className="space-y-3 text-sm">
                ...
                {values.items && values.items.length > 0 && (
                  <div>
                    <h4 className="mt-2 mb-2 text-base font-semibold">
                      Items:
                    </h4>
                  ...
                  values.people_repair_will_benefit.length > 0 && (
                    <div>
                      ...
                      <ul className="ml-4 list-inside list-disc">
                        {values.people_repair_will_benefit.map(
                          (person, index: number) => (
