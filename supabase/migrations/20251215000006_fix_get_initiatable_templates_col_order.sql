...
-- Issue: template_fields columns don't have order_index, they have order_number
...
COMMENT ON FUNCTION get_initiatable_templates IS 'Returns all active templates in a business unit that the current user can initiate, along with their workflow information. Fixed: changed order_index to order_number for template_fields.';
