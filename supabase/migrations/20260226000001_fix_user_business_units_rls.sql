-- Fix: Allow users to see other members in the same business unit
-- Previously, users could only see their own user_business_units row,
-- which caused the employee list to show only the current user.
