...
-- Issue: Column name is "order" not "order_index" or "order_number"
...
COMMENT ON FUNCTION get_initiatable_templates IS 'Returns templates where user can initiate at least one workflow section. Filters based on workflow_section_initiators matching user roles. Fixed: column name is "order" not "order_index" or "order_number".';
