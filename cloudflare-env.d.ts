/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f04b38114bf55d976bb45441d2fc51ad)
// Runtime types generated with workerd@1.20260625.1 2026-06-28 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	AGILA_BUCKET: R2Bucket;
	CF_SMOKE_BUCKET: R2Bucket;
	AGILA_DB: D1Database;
	CF_SMOKE_DB: D1Database;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SUPABASE_URL: string;
	NEXT_PUBLIC_SUPABASE_PUBLISHABLE_OR_ANON_KEY: string;
	NEXT_PUBLIC_GFORM_SUPPORT_TICKET_LINK: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_PUBLISHABLE_OR_ANON_KEY" | "NEXT_PUBLIC_GFORM_SUPPORT_TICKET_LINK" | "SUPABASE_SECRET_KEY">> {}
}
