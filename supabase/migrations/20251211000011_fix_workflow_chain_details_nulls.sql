-- Fix get_workflow_chain_details to return empty arrays instead of nulls
-- This ensures the UI always gets arrays for initiators and steps
...
COMMENT ON FUNCTION get_workflow_chain_details IS 'Get detailed workflow chain information including role and template names for UI display. Returns empty arrays instead of nulls for better UI handling.';
