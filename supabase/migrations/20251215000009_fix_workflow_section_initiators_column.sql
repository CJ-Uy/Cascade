...
-- Issue: workflow_section_initiators table uses "role_id" not "initiator_role_id"
...
COMMENT ON FUNCTION get_initiatable_templates IS 'Returns templates where user can initiate at least one workflow section. Filters based on workflow_section_initiators matching user roles. Fixed: use role_id column not initiator_role_id.';
